...
class __TwigTemplate_f91871baebed6de1b046a8d78dc8fd47df2bebcecdf34abe627c27b9ff72e605 extends Template
{
    private $source;
    private $macros = [];
    ...
    <table class=\"table\">
        ...
        echo "</td>
            ...
            <tr>
                ...
                <td>";
        // line 20
        echo ((twig_get_attribute($this->env, $this->source, (isset($context["comment"]) || array_key_exists("comment", $context) ? $context["comment"] : (function () { throw new RuntimeError('Variable "comment" does not exist.', 20, $this->source); })()), "private", [], "any", false, false, false, 20)) ? ("Yes") : ("No"));
        echo "</td>
            </tr>
        </tbody>
    </table>
...
{% endblock %}
", "comment/show.html.twig", "/var/www/becode/call-center/templates/comment/show.html.twig");
    }
}
