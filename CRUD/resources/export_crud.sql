...
CREATE DATABASE /*!32312 IF NOT EXISTS*/ `db_crud` /*!40100 DEFAULT CHARACTER SET utf8mb4 */;
...
CREATE TABLE `student` (
  ...
  CONSTRAINT `student_FK` FOREIGN KEY (`class_id`) REFERENCES `class` (`id`) ON DELETE SET NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
/*!40101 SET character_set_client = @saved_cs_client */;
...
-- Dump completed on 2020-08-10 11:58:02
